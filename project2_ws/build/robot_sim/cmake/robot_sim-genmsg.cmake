...
message(STATUS "robot_sim: 1 messages, 1 services")

set(MSG_I_FLAGS "-Irobot_sim:/home/minglun/project2_ws/src/robot_sim/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/minglun/project2_ws/src/robot_sim/msg/RobotState.msg" NAME_WE)
add_custom_target(_robot_sim_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_sim" "/home/minglun/project2_ws/src/robot_sim/msg/RobotState.msg" ""
)

get_filename_component(_filename "/home/minglun/project2_ws/src/robot_sim/srv/RobotAction.srv" NAME_WE)
add_custom_target(_robot_sim_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_sim" "/home/minglun/project2_ws/src/robot_sim/srv/RobotAction.srv" ""
)
...
_generate_msg_cpp(robot_sim
  "/home/minglun/project2_ws/src/robot_sim/msg/RobotState.msg"
  "${MSG_I_FLAGS}"
  ""
...
_generate_srv_cpp(robot_sim
  "/home/minglun/project2_ws/src/robot_sim/srv/RobotAction.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/robot_sim
)
