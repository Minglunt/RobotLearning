...
if("TRUE" STREQUAL "TRUE")
  set(robot_sim_SOURCE_PREFIX /home/minglun/project3_ws/src/robot_sim)
  set(robot_sim_DEVEL_PREFIX /home/minglun/project3_ws/devel)
  ...
  set(robot_sim_INSTALL_PREFIX /home/minglun/project3_ws/install)
...
if(NOT "/home/minglun/project3_ws/devel/include " STREQUAL " ")
  set(robot_sim_INCLUDE_DIRS "")
  set(_include_dirs "/home/minglun/project3_ws/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Matei <matei.ciocarlie@columbia.edu>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_sim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/minglun/project3_ws/src/robot_sim/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/minglun/project3_ws/devel/lib;/home/minglun/project3_ws/devel/lib;/opt/ros/kinetic/lib)
...
set(robot_sim_EXPORTED_TARGETS "robot_sim_generate_messages_cpp;robot_sim_generate_messages_eus;robot_sim_generate_messages_lisp;robot_sim_generate_messages_nodejs;robot_sim_generate_messages_py")
...
set(pkg_cfg_extras "robot_sim-msg-extras.cmake")
